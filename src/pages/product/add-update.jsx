...
class ProductAddUpdate extends Component {
    ...
    /**
     * 获取一级/二级分类列表
     * async 函数的返回值是一个新的promise对象，promise的结果和值，由async的结果来决定
     */
    getCategorys = async (parentId) => {
        ...
        if (result.status === 0) {
            ...
            // 判断是一级分类还是二级分类，如果是一级分类            
            if (parentId === 0) {
                this.initOptions(categorys)
            } else {
                // 二级列表,当前async函数返回的promise就会成功且value为categorys
                return categorys
            }
        }
    }
        ...
        return (
            <Card title={title} >
                <Form {...formItemLayout}>
                    ...
                    <Item label="" wrapperCol={{ span: 12, offset: 2 }}>
